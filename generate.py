...
def main(
    ...
    if CLI:
        ...
        gr.Interface(
            theme=mytheme,
            title="🧪 BAI-Chem",
            description="It is a 7B-parameter vicuna model finetuned to follow instructions. It is trained on the mol instruction dataset and makes use of the Huggingface LLaMA implementation.",  # noqa: E501
            fn=evaluate,
            inputs=[
